            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white">
                  Pedido #{order.display_number ?? order.id}
                </h2>
                {order.is_takeaway ? (
          ...
          <div className="space-y-6">
                ...
                onChange={async (e) => {
                  ...
                  try {
                    ...
                    toast({
                      ...
                      description: `Pedido #${order.display_number ?? order.id} movido a ${label}`,
            ...
            <div>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-darkbg dark:to-darkbg-darker rounded-xl p-5 shadow-sm border border-gray-200 dark:border-darkbg">
                {order.user?.phone ? (
                  <a
                    href={`https://api.whatsapp.com/send?phone=${order.user.phone}&text=Hola,%20te%20contactamos%20desde%20Cuckoo%20respecto%20a%20tu%20pedido%20%23${order.display_number ?? order.id}`}
                    target="_blank"
