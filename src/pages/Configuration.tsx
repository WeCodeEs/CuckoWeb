    ...
    <div className="min-h-screen bg-gray-50 dark:bg-darkbg transition-colors duration-200">
      <div className="p-6 space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-2xl font-bold text-primary-dark dark:text-white">Configuración</h1>
            <p className="text-sm text-gray-600 dark:text-gray-300">Ajustes generales del sistema</p>
          </div>
        </div>
