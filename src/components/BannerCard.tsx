  ...
  return (
    <div
      ...
      className={`bg-white dark:bg-darkbg-lighter rounded-xl border-2 ${
        isDragging
          ? 'border-primary dark:border-secondary shadow-2xl opacity-50'
    ...
    >
      ...
      <div className="p-3 flex items-center justify-between gap-2">
        <button
          onClick={() => onPreview(banner)}
          className="flex-1 px-3 py-2 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors text-xs font-medium flex items-center justify-center gap-1.5"
          title="Vista previa"
        >
        ...
        <button
          ...
          className="px-3 py-2 bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors text-xs font-medium flex items-center justify-center gap-1.5"
          title="Eliminar"
        >
